...
<div class="bhk-selector fixed right-5 top-8 z-[1111]">
...
{#if !$startTour}
	<div class="left-panel bhk-selector details-panel fixed right-5 top-20 z-[999] p-2">
		<div class="left-panel--header flex justify-between gap-[1rem] lg:gap-[3rem]">
			...
			>
				{#if !$isInteriorUnitDataMinimized}
					<img id="un-mm" src={minimizeBtn} alt="minimize" class="!w-6" />
				{/if}
				{#if $isInteriorUnitDataMinimized}
					<img id="un-mx" src={maximizeBtn} alt="maximize" class="!w-6" />
				{/if}
			</button>
		</div>
...
{#if $startTour}
	<div class="left-panel-wrapper">
		...
		<div class="left-panel details-panel-lg p-2">
			<div class="left-panel--header flex justify-between gap-[1rem] lg:gap-[3rem]">
				<div class="left-title flex items-center font-bold">
					<svg
						width="25"
				...
				>
					{#if !$isInteriorUnitDataMinimized}
						<img id="un-mm" src={minimizeBtn} alt="minimize" class="sm:w-5 lg:w-full" />
					{/if}
					{#if $isInteriorUnitDataMinimized}
						<img id="un-mx" src={maximizeBtn} alt="maximize" class="sm:w-5 lg:w-full" />
					{/if}
				</button>
			</div>
